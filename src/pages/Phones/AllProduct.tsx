...
const AllProduct = () => {
  ...
  const hasActiveFilters = search || brand !== "all" || category !== "all" || priceRange[0] > 0 || priceRange[1] < 2000;
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-primary mb-4">
            All <span className="text-secondary">Smartphones</span>
          </h1>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Discover our complete collection of premium smartphones from top brands
          </p>
        </div>
